...
- Added Client APIs (Create, Delete, Get, List, ListAll, Update) 
  to interact with `ClonedPluginDefinition` and `CustomPluginDefinition`.
  [#619](https://github.com/Kong/go-kong/pull/619)
...
- Added support for `Service` field in `GraphqlRateLimitingCostDecoration`.
  [#608](https://github.com/Kong/go-kong/pull/608)
...
- Added support for fetching all targets for all upstreams
  [#599](https://github.com/Kong/go-kong/pull/599)
