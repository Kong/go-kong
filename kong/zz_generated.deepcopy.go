...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSSANs) DeepCopyInto(out *TLSSANs) {
	*out = *in
	if in.DNSNames != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSSANs.
func (in *TLSSANs) DeepCopy() *TLSSANs {
	if in == nil {
		return nil
	}
	out := new(TLSSANs)
